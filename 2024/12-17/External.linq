...
Program: 2,4,1,3,7,5,4,0,1,3,0,3,5,5,3,0";
	...
	Console.WriteLine($"Part 1: Output is {solution.PartOne(input)}");
	Console.WriteLine($"Part 2: Register A is {solution.PartTwo(input)}");
}
...
class Solution
{
    ...
    */
	...
	{
		var blocks = input.Split("--").Select(ParseNums).ToArray();
